...
// LettersGeo is an array of letter transliteration in geographical standard
var LettersGeo = map[rune]Letter{
	'А': Letter{PositionOther: []rune{'A'}},
	'а': Letter{PositionOther: []rune{'a'}},
	'Б': Letter{PositionOther: []rune{'B'}},
	'б': Letter{PositionOther: []rune{'b'}},
	...
	'Ш': Letter{PositionOther: []rune{'S', 'h'}},
	'ш': Letter{PositionOther: []rune{'s', 'h'}},
	'Ь': Letter{PositionOther: []rune{'\''}},
	'ь': Letter{PositionOther: []rune{'\''}},
	'Щ': Letter{PositionOther: []rune{'S', 'c', 'h'}},
	'щ': Letter{PositionOther: []rune{'s', 'c', 'h'}},
	'Ю': Letter{PositionOther: []rune{'I', 'u'}, PositionFirst: []rune{'Y', 'u'}},
	'ю': Letter{PositionOther: []rune{'i', 'u'}, PositionFirst: []rune{'y', 'u'}},
	'Я': Letter{PositionOther: []rune{'I', 'a'}, PositionFirst: []rune{'Y', 'a'}},
...
// ReplaceUARunesGeo is like ReplaceUARunes, but with Geographical standart of 1996 year
func ReplaceUARunesGeo(uaRunes []rune) (engRunes []rune) {
	isFirst := true
	previousZ := false
	for _, rune := range uaRunes {
		// test for "зг"
		...
		newRunes := ReplaceUARuneGeo(rune, isFirst)
		engRunes = append(engRunes, newRunes...)
		if newRunes[0] == rune {
			isFirst = true
			continue
...
// ReplaceUARuneGeo is a func which replace UA rune with list of ENG runes if UA rune exist
func ReplaceUARuneGeo(uaRune rune, isFist bool) []rune {
	letter, exist := LettersGeo[uaRune]
	if !exist {
		return []rune{uaRune}
	}
	if isFist && letter.PositionFirst != nil {
